...
for i in os.listdir('files_from_separate_Pfam_to_counts'):
    if i != 'format':
        name = i
        os.system('python3 formatting.py -F files_from_separate_Pfam_to_counts/%s' % i)
print('Done!')

# --------------------------------------------------------------------------------------------------------

print('Extracting 2-repeats from full sequences...')
os.system('python3 full_seq_extract_n_counts.py -F %s -S files_from_separate_Pfam_to_counts/%s' % (args.F, name))
print('Done!')
...
for i in os.listdir('files_from_full_seq_extract_n_counts'):
    if i != 'format':
        name = i
        os.system('python3 formatting.py -F files_from_full_seq_extract_n_counts/%s' % i)
print('Done!')
...
for i in os.listdir('files_from_separate_groups_to_counts'):
    if i != 'format':
        name = i
        os.system('python3 formatting.py -F files_from_separate_groups_to_counts/%s' % i)
print('Done!')
...
for i in os.listdir('files_from_separate_groups_to_counts'):
    if i != 'format':
        name = i
        os.system('python3 advanced_filter_by_value.py -F files_from_separate_groups_to_counts/%s' % i)
print('Done!')
...
for i in os.listdir('files_from_advanced_filter_by_value'):
    if i != 'format':
        name = i
        os.system('python3 formatting.py -F files_from_advanced_filter_by_value/%s' % i)
print('Done!')
